...
/**
 * This utility helps ensure that the necessary scripts for different
 * embed platforms are loaded only once in the document.
 */
...
export const loadTwitterWidgets = () => {
  ...
  if (!document.getElementById('twitter-widget-script')) {
    ...
    return new Promise<void>((resolve) => {
      script.onload = () => {
        // Re-process any existing tweets
...
export const loadInstagramEmbeds = () => {
  // Only load if not already loaded
  if (!document.getElementById('instagram-embed-script')) {
    ...
    return new Promise<void>((resolve) => {
      script.onload = () => {
        // Re-process any existing embeds
...
// Function to load all embed scripts at once
export const loadAllEmbedScripts = () => {
  return Promise.all([
    loadTwitterWidgets(),
    loadInstagramEmbeds()
  ])
