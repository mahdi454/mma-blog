...
import { BoldIcon, CircleOff, CodeIcon, GripHorizontal, ItalicIcon, StrikethroughIcon, UnderlineIcon } from "lucide-react"
...
export const SectionTwo: React.FC<SectionTwoProps> = ({
  ...
  return (
    <ToolbarSection
      ...
      dropdownIcon={<GripHorizontal className="size-5" />}
